...
local M = Class('Activity_Fund2', UIItemBase)
function M:ctor()
    M.super.ctor(self)
    self.PathPrefab = 'ABOriginal/UI/Prefab/Template/Activity_Fund2.prefab'
    -- 没有使用组建缓存列表
    self.CC = {
        -- Image 列表
        {'Activity_Fund2','/',2},{'ImgFund2TimeBg','ImgFund2TimeBg',2},{'TaskPanel','TaskPanel',2},{'Jiangli','TaskPanel/Jiangli',2},{'Content','TaskPanel/TaskAwardScroll/Content',2},{'Btn_UnTaskceive','TaskPanel/Btn_UnTaskceive',2},{'Btn_TaskCeive','TaskPanel/Btn_TaskCeive',2},
        -- UITemplate 列表
        {'Activity_Fund201','/',10},{'Fund2TaskItem','TaskPanel/TaskAwardScroll/Fund2TaskItem',10},
        -- LoopScrollRect 列表
        {'TaskAwardScroll','TaskPanel/TaskAwardScroll',18},
        -- TextMeshProUGUI 列表
        {'TextFund2Time','ImgFund2TimeBg/TextFund2Time',20},{'Text_Jifendianshu','Jifendianshu/Text_Jifendianshu',20},{'Text_Point','Jifendianshu/Text_Point',20},{'Text_Jiangli','TaskPanel/Jiangli/Text_Jiangli',20},{'Text_YiJianLingQu','TaskPanel/Btn_UnTaskceive/Text_YiJianLingQu',20},{'Text_YiJianLingQu01','TaskPanel/Btn_TaskCeive/Text_YiJianLingQu',20},
    }
end
...
function M:GetMissionList()
    self.missionList = {}
    ---@type ActivityData
    self.pData = ActivityControl.GetActivityInfo(991)
    ...
    for k,v in pairs(MonthlyrechargeLocalData.tab) do
        if v[5] == self.pData.version then
            local arr = {
                id = v[1],
                activityId = v[2],
                money = v[3],
...
function M:ReloadMission(offset)
    ...
    --检查按钮状态
    if RedDotControl.GetDotData("MonthlyRecharge").State == true then
