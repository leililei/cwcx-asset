...
function M:ctor()
    ...
    self.CC = {
        ...
        -- RawImage 列表
        {'ShopItemScroll','UI_Canvas/RightPanel/NiudanjiXiangqing/ShopItemScroll',15},{'Content','UI_Canvas/RightPanel/NiudanjiXiangqing/ShopItemScroll/Content',15},
        -- LoopScrollRect 列表
        {'ShopItemScroll01','UI_Canvas/RightPanel/NiudanjiXiangqing/ShopItemScroll',18},
        -- TextMeshProUGUI 列表
        {'Text_shuliang','UI_Canvas/RightPanel/Niudanji/Btn_Chou1ci/Text_shuliang',20},{'Text_xiaohao','UI_Canvas/RightPanel/Niudanji/Btn_Chou1ci/Text_xiaohao',20},{'Text_TenDraw','UI_Canvas/RightPanel/Niudanji/Btn_Chou10ci/Text_TenDraw',20},{'Text_TebDrawPrice','UI_Canvas/RightPanel/Niudanji/Btn_Chou10ci/Text_TebDrawPrice',20},{'Text_Title_CN','UI_Canvas/ReturnBg/Text_Title/Text_Title_CN',20},{'Text_Title_EN','UI_Canvas/ReturnBg/Text_Title/Text_Title_EN',20},{'RoleVoiceWordText','UI_Canvas/Img_SoundTextBG/RoleVoiceWordText',20},
    }
end
...
function M:OnInit()
    self:InitBtn()  --初始化按钮
    self.ShopItemScroll01():SetLuaCellEvent(Handle(self, self.ItemCell))  --注册滑动
    --UI
