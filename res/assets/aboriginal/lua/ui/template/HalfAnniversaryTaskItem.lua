...
local M = Class('HalfAnniversaryTaskItem', UIItemBase)
function M:ctor()
    M.super.ctor(self)
    self.PathPrefab = 'ABOriginal/UI/Prefab/Template/HalfAnniversaryTaskItem.prefab'
    -- 没有使用组建缓存列表
    self.CC = {
        -- Image 列表
        {'MissionBg','MissionBg',2},{'Img_CanReceivebg','Img_CanReceivebg',2},{'Img_GouIcon','Img_CanReceivebg/Img_GouIcon',2},{'Img_Goudi','Img_CanReceivebg/Img_Goudi',2},{'RewardPanel','RewardPanel',2},{'RewardItem','RewardPanel/RewardItem',2},{'RewardRankImg','RewardPanel/RewardItem/RewardRankImg',2},{'RewardIconImg','RewardPanel/RewardItem/RewardIconImg',2},{'Img_ItemCountBg','RewardPanel/RewardItem/Img_ItemCountBg',2},{'StarPanel','RewardPanel/RewardItem/StarPanel',2},{'EmptyStarRoot','RewardPanel/RewardItem/StarPanel/EmptyStarRoot',2},{'EmptyStar','RewardPanel/RewardItem/StarPanel/EmptyStarRoot/EmptyStar',2},{'EmptyStar01','RewardPanel/RewardItem/StarPanel/EmptyStarRoot/EmptyStar',2},{'EmptyStar02','RewardPanel/RewardItem/StarPanel/EmptyStarRoot/EmptyStar',2},{'EmptyStar03','RewardPanel/RewardItem/StarPanel/EmptyStarRoot/EmptyStar',2},{'EmptyStar04','RewardPanel/RewardItem/StarPanel/EmptyStarRoot/EmptyStar',2},{'EmptyStar05','RewardPanel/RewardItem/StarPanel/EmptyStarRoot/EmptyStar',2},{'ItemStarRoot','RewardPanel/RewardItem/StarPanel/ItemStarRoot',2},{'ItemStarPrefab','RewardPanel/RewardItem/StarPanel/ItemStarPrefab',2},{'Img_Received','RewardPanel/RewardItem/Img_Received',2},{'Img_TaskProgressBarBg','Img_TaskProgressBarBg',2},{'Img_TaskProgressBar','Img_TaskProgressBarBg/Img_TaskProgressBar',2},{'CompletedPanel','CompletedPanel',2},{'Img_Cleared','CompletedPanel/Img_Cleared',2},{'Img_Completeddi','CompletedPanel/Img_Completeddi',2},
        -- UITemplate 列表
        {'HalfAnniversaryTaskItem','/',10},
        -- TextMeshProUGUI 列表
        {'ItemCountText','RewardPanel/RewardItem/Img_ItemCountBg/ItemCountText',20},{'Text_Yilingqu2','RewardPanel/RewardItem/Img_Received/Text_Yilingqu2',20},{'Text_TaskTitle','Text_TaskTitle',20},{'Text_TaskProgress','Text_TaskProgress',20},
    }
end
