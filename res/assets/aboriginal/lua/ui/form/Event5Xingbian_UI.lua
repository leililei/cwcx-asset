...
local M = Class('Event5Xingbian_UI', UIBase)
function M:ctor()
    M.super.ctor(self)
    self.Uid = UID.Event5Xingbian_UI
    self.PathPrefab = 'ABOriginal/Prefab/Form/Form[Event5Xingbian_UI].prefab'
    self.Name = 'Form[Event5Xingbian_UI]'
