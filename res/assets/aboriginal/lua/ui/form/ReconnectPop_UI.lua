...
local M = Class('ReconnectPop_UI', UIBase)
function M:ctor()
    M.super.ctor(self)
    self.Uid = UID.ReconnectPop_UI
    self.PathPrefab = 'ABOriginal/Prefab/Form/Form[ReconnectPop_UI].prefab'
    self.Name = 'Form[ReconnectPop_UI]'
