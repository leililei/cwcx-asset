...
function TeamData:PushData(team)
    ...
    self.info = team.data == nil and {} or team.data
    self.tryHero = {};
    if nil ~= team.tryHero and nil ~= team.tryHero.data then
        self.tryHero = team.tryHero.data;
    end
end
---设置名称
...
function TeamData:SetTryHero(tryHero)
    self.tryHero = tryHero
end
return TeamData