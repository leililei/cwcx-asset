...
local M = Class('RoleArchive_SkillItem', UIItemBase)
function M:ctor()
    M.super.ctor(self)
    self.PathPrefab = 'ABOriginal/UI/Prefab/Template/RoleArchive_SkillItem.prefab'
    -- 没有使用组建缓存列表
    self.CC = {
        -- Image 列表
        {'Img_Jinengdi','Img_Jinengdi',2},{'TagPanel','TagPanel',2},{'Img_Tag','Img_Tag',2},{'EX','EX',2},{'Img_Jinengdian1','Img_Jinengdian1',2},{'Img_Jinengdian2','Img_Jinengdian2',2},{'Img_Jinengdian_hui','Img_Jinengdian_hui',2},{'JinengdianPanel','JinengdianPanel',2},{'Img_Suo','Img_Suo',2},
        -- UITemplate 列表
        {'RoleArchive_SkillItem','/',10},
        -- TextMeshProUGUI 列表
