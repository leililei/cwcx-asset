...
local M = Class('GearBagSortToggle', UIItemBase)
function M:ctor()
    M.super.ctor(self)
    self.PathPrefab = 'ABOriginal/UI/Prefab/Template/GearBagSortToggle.prefab'
    -- 没有使用组建缓存列表
    self.CC = {
        -- Image 列表
        {'GearBagSortToggle','/',2},{'Normal','Normal',2},{'jiantou(hui)2','Normal/jiantou(hui)2',2},{'HighLight','HighLight',2},{'H_Normal','HighLight/H_Normal',2},{'kuang(dangqian)','HighLight/H_Normal/kuang(dangqian)',2},{'jiantou(cheng)','HighLight/H_Normal/jiantou(cheng)',2},{'H_HighLight','HighLight/H_HighLight',2},{'kuang(dangqian)01','HighLight/H_HighLight/kuang(dangqian)',2},{'jiantou(cheng)01','HighLight/H_HighLight/jiantou(cheng)',2},
        -- UITemplate 列表
        {'GearBagSortToggle01','/',10},
        -- Toggle 列表
        {'GearBagSortToggle02','/',13},{'HighLight01','HighLight',13},
        -- TextMeshProUGUI 列表
...
function M:OnUpdateUI(pData)
    ...
    ---添加事件
    Tools.ToggleValueChange(self.GearBagSortToggle02(),Handle(self,self.OnSortClick),nil)
    ---添加子事件
