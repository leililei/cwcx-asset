...
local M = Class('RoleCardItem', UIItemBase)
function M:ctor()
    M.super.ctor(self)
    self.PathPrefab = 'ABOriginal/UI/Prefab/Template/RoleCardItem.prefab'
    -- 没有使用组建缓存列表
    self.CC = {
        -- Image 列表
        ...
        -- TextMeshProUGUI 列表
        {'SkillText','btn_uiTx/RANK/SkillText',20},{'LVText','btn_uiTx/LV/LVText',20},{'RoleNameText','btn_uiTx/RoleNameText',20},
    }
end
