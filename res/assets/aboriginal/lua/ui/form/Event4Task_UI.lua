...
local M = Class('Event4Task_UI', UIBase)
function M:ctor()
    M.super.ctor(self)
    self.Uid = UID.Event4Task_UI
    self.PathPrefab = 'ABOriginal/Prefab/Form/Form[Event4Task_UI].prefab'
    self.Name = 'Form[Event4Task_UI]'
