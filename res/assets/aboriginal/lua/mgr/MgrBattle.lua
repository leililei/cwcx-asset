...
MgrBattle.fightType = {
    ...
    boss = 3, ---世界boss
    pvp = 4,          ---玩家对战
    friendPVP = 5,   ---好友对战队伍界面
    friendPVPBattle = 6, ---好友对战战斗
    wudaohuiReady = 7   ---武道会布阵界面
}
---战斗对应ui
MgrBattle.fightUI = {
    ...
    [MgrBattle.fightType.friendPVP] = UID.FirendReady_UI,
    [MgrBattle.fightType.friendPVPBattle] = UID.Battle02_UI,
    [MgrBattle.fightType.wudaohuiReady] = UID.WDHReady_UI,
}
...
local _startBattle = function (curType, callback,mapName)
    ...
    if mapName == nil or mapName == "0" then
