...
local M = Class('RoleDamageItem2', UIItemBase)
function M:ctor()
    M.super.ctor(self)
    self.PathPrefab = 'ABOriginal/UI/Prefab/Template/RoleDamageItem2.prefab'
    -- 没有使用组建缓存列表
    self.CC = {
        -- Image 列表
        ...
        {'RoleDamageItem2','/',10},
        -- TextMeshProUGUI 列表
        {'Text_Paiming','Paiming/Text_Paiming',20},{'Text_Shanghai','Shanghaitiaodi/Text_Shanghai',20},{'Text_Baifenbi','Shanghaitiaodi/Text_Baifenbi',20},{'Text_Level','BattleRoleItem/Panel/Text_Level',20},{'Text_Lv','BattleRoleItem/Panel/Text_Lv',20},{'Text_Rank','BattleRoleItem/Panel/Icon_Rankdi/Text_Rank',20},{'Text_Weishangzhen','Text_Weishangzhen',20},
    }
end
-- Code Auto Create End
function M:OnInit()
    self.Text_Weishangzhen().gameObject:SetActive(false)
    self.NormalStar = {
